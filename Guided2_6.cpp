...
struct antrian{
    int depan;
    int belakang;
    string *nama = new string[maksimal_antrian];
}mahasiswa;
...
int main(){
    ...
    cout<<"5. Keluar"<<endl; cout<<"Silahkan pilih (1-5) : ";
    cin>>pilihan;

    switch(pilihan){
        case 1 : cout<<"Masukkan jumlah maksimal antrian (bilangan bulat) : ";
        ...
        cin>>data_masuk; enqueue_antrian(data_masuk);
        cout<<"Keluar (y/t) ? ";
        cin>>ya_tidak;
        if(ya_tidak == 'y' || ya_tidak == 'Y'){
            cout<<" Jumpa kembali "<<endl;
        ...
        case 4 :
            ...
            case 5 :
                ...
                cin>>ya_tidak;
                if(ya_tidak == 'y' || ya_tidak == 'Y'){ cout<<
                    "Terima kasih"<<endl; keluar = true;
                }system("cls");
                break;
